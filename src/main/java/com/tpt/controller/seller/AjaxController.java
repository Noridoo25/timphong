...
//		List<Phong> phongs = ConstantFunction.get9Phong(ConstantFunction.locPhong(searchPhong, loc));
		...
		for (Phong p : phongs) {
			out.println("										<tr class=\"phong\">\r\n"
					...
					+ "											<td>" + p.getXa().getTenxa() + ", " + p.getXa().getHuyen().getTenhuyen() + ", "+  
					p.getXa().getHuyen().getTinh().getTentinh() + "</td>\r\n"
					+ "											<td><a\r\n"
					+ "												href=\"/timphong/seller/ql-phong/select?id_p=" + p.getId_p() + "\"><button\r\n"
					+ "														class=\"btn btn-success btn-sm rounded-0\" type=\"button\"\r\n"
					+ "														data-toggle=\"tooltip\" data-placement=\"top\" title=\"Edit\">\r\n"
					+ "														<i class=\"fa fa-edit\"></i>\r\n"
					+ "													</button></a></td>\r\n"
					+ "											<td><a\r\n"
					+ "												href=\"/timphong/seller/ql-phong/delete?id_p=" + p.getId_p() + "\"><button\r\n"
