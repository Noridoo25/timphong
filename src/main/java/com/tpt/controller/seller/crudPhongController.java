...
{ "/seller/ql-phong/them-anh-phong", "/seller/ql-phong/xoa-anh-phong", "/seller/ql-phong", "/seller/ql-phong/select",
		"/seller/ql-phong/insert", "/seller/ql-phong/delete", "/seller/ql-phong/reset", "/seller/ql-phong/update" })
public class crudPhongController extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		if (url.contains("them-anh-phong"))
		{
			req.setAttribute("id_p", req.getParameter("id_p"));
			req.getRequestDispatcher("/views/seller/themanhphong.jsp").forward(req, resp);
		} else if (url.contains("select"))
		{
			getPhong(req, resp);
		} else
		{
	...
	protected void findPhongSeller(HttpServletRequest req, HttpServletResponse resp)
...
//			}
	...
	protected void themAnhPhong(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		req.setCharacterEncoding("utf-8");
		resp.setCharacterEncoding("utf-8");
		...
		resp.sendRedirect(req.getContextPath() + "/seller/ql-phong/select?id_p=" + id_pString);
	}
}
