...
public class DathenDaoImpl extends DBConnection implements IDathenDao 
{
	...
	public List<Dathen> getAllcho() {
		String sql = "select * from dathen where dathen.trangthai = 1";
		List<Dathen> dathens = new ArrayList<>();
		try
		{
			connection = super.getConnection();
	...
	public List<Dathen> getAllxn() {
		String sql = "select * from dathen where dathen.trangthai = 2";
		List<Dathen> dathens = new ArrayList<>();
		try
		{
			connection = super.getConnection();
	...
	public List<Dathen> getAllhuy() {
		String sql = "select * from dathen where dathen.trangthai = 3";
		List<Dathen> dathens = new ArrayList<>();
		try
		{
			connection = super.getConnection();
	...
	public List<Dathen> get3xn() {
		String sql = "select top 3 * from dathen where dathen.trangthai = 2";
		List<Dathen> dathens = new ArrayList<>();
		try
		{
			connection = super.getConnection();
	...
	public List<Dathen> get3huy() {
		String sql = "select top 3 * from dathen where dathen.trangthai = 3";
		List<Dathen> dathens = new ArrayList<>();
		try
		{
			connection = super.getConnection();
