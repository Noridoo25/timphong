			...
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-md-6 mt-lg-5 text-center">
						<h1 class="text-shadow">Tìm kiếm phòng, nhà ở nhanh chóng</h1>
						<br>
						...
						<div class="ftco-media-1-inner">
							<a href="<c:url value='/detail-phong?id_p=${phong.id_p}'/>"
								...
								<div class="ftco-media-details text-dark">
									...
									<p class="pr-3">Đ/c: ${phong.getXa().getTenxa()},
										${phong.getXa().getHuyen().getTenhuyen()},
										${phong.getXa().getHuyen().getTinh().getTentinh()}</p>
									<p>Số người ở tối đa: ${phong.getSonguoi() }</p>
									<p>Đánh giá: ${phong.danhgia != 0 ? phong.danhgia:"Chưa có đánh giá"}${phong.danhgia != 0 ? "/5.0":""}</p>
									<p>Có ${phong.quantam } người quan</p>
								</div>
							</a>
						</div>
					</div>
