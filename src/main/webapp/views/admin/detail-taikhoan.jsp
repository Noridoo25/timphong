						...
						<div class="row">
							...
							<div class="col-12 mb-3">
								<label class="label-info-admin pr-3">Mật khẩu: </label><input
									readonly class="col-12 py-2 border-radius-12" type="password"
						...
						<div class="row">
							<div class="col-12 mb-3">
								<label class="label-info-admin pr-3">Họ: </label><input
									 readonly class="col-12 py-2 border-radius-12" type="text" name="ho"
									value="${user.ho }">
							</div>
							<div class="col-12 mb-3">

								<label class="label-info-admin pr-3">Tên: </label><input
									readonly class="col-12 py-2 border-radius-12" type="text" name="ten"
									value="${user.ten }">
							</div>
							<div class="col-12 mb-3">
								<label class="label-info-admin pr-3">SDT: </label><input
									readonly class="col-12 py-2 border-radius-12" type="text" name="sdt"
									value="${user.sdt }">
							</div>
							<div class="col-12 mb-3">
								<label class="label-info-admin pr-3">Email: </label><input
									readonly class="col-12 py-2 border-radius-12" type="text" name="email"
									value="${user.email }">
							</div>
						</div>
					</div>
				...
				<table class="table">
					<thead class="thead-dark">
						<tr>
							...
							<th scope="col-3">Tên phòng</th>
							<th scope="col-2">Trạng thái</th>
							<th scope="col-2">Giá</th>
							<th scope="col-3">Diện tích</th>
							<th scope="col-5">Hành động</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${phongcts}" var="phongct" varStatus="STT">
							<tr>
								...
								<td class="col-3 text-center">${phongct.ten}</td>
								<td class="col-2 text-center">${phongct.trangthai==1 ? "Hiện":"Ẩn"}</td>
								<td class="col-2 text-center">${phongct.gia}</td>
								<td class="col-3 text-center">${phongct.chieudai}*${phongct.chieurong}</td>
								<td class="col-5 text-center"><a
									href="<c:url value="/admin/xoa-phong?id_p=${phongct.id_p }&id_taikhoan=${user.id_tk }"/>">Xóa</a>
									<a 
									href="<c:url value="/admin/phong?id_p=${phongct.id_p }&id_taikhoan=${user.id_tk}"/>">Edit</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
